      ...
      >
        <View style={styles.overlay}>
          ...
          <View style={styles.bottomCard}>
            <Text style={styles.title}>{`Powering\nTomorrow\nSustainably`}</Text>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: '800', color: '#1c1c1e', lineHeight: 32, flexShrink: 1 },
  subtitle: { fontSize: 13, lineHeight: 18, color: 'rgba(28,28,30,0.7)', fontWeight: '600' },
  ctaHolder: {
    position: 'absolute',
    right: -30,
    bottom: -15,
