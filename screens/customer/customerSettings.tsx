...
export default function CustomerSettingsScreen({ onBack, onSignOut, onOpenBookings, onOpenCalculator, onOpenPosts, onOpenSettings, onGoHome }: { onBack?: () => void; onSignOut?: () => void; onOpenBookings?: () => void; onOpenCalculator?: () => void; onOpenPosts?: () => void; onOpenSettings?: () => void; onGoHome?: () => void }) {
          ...
          <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
            ...
            <BlurView intensity={24} tint="light" style={styles.card}>
              <View style={styles.profileRow}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.email}>{mobile || 'Loading...'}</Text>
                </View>
            ...
            <BlurView intensity={22} tint="light" style={styles.card}>
              <View style={{ paddingVertical: 8 }}>
                <Text style={styles.name}>Klord Energy</Text>
                <Text style={styles.email}>Version 1.0.0</Text>
              </View>
            </BlurView>

            {/* Sign out */}
            <Pressable style={styles.signOutBtn} onPress={onSignOut} accessibilityRole="button" accessibilityLabel="Sign out">
