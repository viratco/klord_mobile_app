...
export default function Calculator({ onBack, onSelect }: { onBack?: () => void; onSelect?: (c: any) => void }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <ImageBackground
        source={require('../../assets/green-energy-concept-renewable-energy-power-plant-with-solar-panels-and-windmills-tiny-woman-with-big-smartphone-global-eco-industry-modern-flat-cartoon-style-illustration-vector-removebg-preview.png')}
      ...
      >
        ...
        <SafeAreaView style={{ flex: 1 }} edges={['top', 'bottom']}>
          ...
          <View style={styles.backRow}>
            <BouncyPressable onPress={onBack} hitSlop={8} style={styles.backPressable}>
          ...
          <View style={styles.infoCardWrap}>
            <BlurView intensity={32} tint="light" style={styles.infoCard}>
              ...
              />
              <Text style={styles.infoTitle}>Industrial</Text>
              <Text style={styles.infoText}>
                Industrial solar panel systems are designed for large-scale energy production,
                featuring high-efficiency photovoltaic modules that can generate substantial power
                for manufacturing facilities, warehouses, and commercial operations. These robust
                systems offer significant cost savings, reduced carbon footprint, and long-term
                energy independence for industrial applications.
              </Text>
            </BlurView>
          </View>
          ...
          <View style={styles.bottomButtonWrap}>
            <BouncyPressable style={styles.bottomButton} onPress={() => onSelect && onSelect(selectedCategory)}>
              <LinearGradient
      ...
      <BlurView intensity={28} tint="light" style={styles.sliderParent}>
        ...
        <View style={styles.sliderContent}>
          {items.map((it) => {
            ...
            return (
              <BouncyPressable key={it.id} onPress={() => handleSelect(it.id)} style={styles.sliderItem}>
                <BlurView intensity={active ? 36 : 18} tint="light" style={[styles.pillButton, active && styles.pillButtonActive]}>
